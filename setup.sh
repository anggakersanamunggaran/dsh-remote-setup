...
echo ""
echo "    2) ⚠️ JANGAN LUPA — BIKIN PASSWORD AKUN WINDOWS:"
echo "       Settings > Accounts > Sign-in options > Password > Add"
echo "       (SSH NOLAK login kalau password kosong. Auto-login tetap"
echo "        bisa: Win+R > netplwiz > hapus centang 'Users must enter"
echo "        a user name and password' > isi password > OK)"
echo ""
echo "    3) Jalankan port-forward DSH:"
